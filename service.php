...
<head>
    <meta charset="utf-8">
    <title>Layanan - Banana Edition</title>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <p>Kami menghadirkan beragam pilihan layanan yang dirancang untuk memenuhi kebutuhan Anda. Diantaranya adalah:</p>
                        <div class="row g-2 mb-4">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center mb-2">
                                    <span class="circle"><i class="fas fa-medal"></i></span><h5>Quality Products</h5>
                                </div>
                                <p>Kami menjamin setiap hidangan yang kami tawarkan dibuat dari bahan-bahan berkualitas tinggi 
                                    untuk memberikan pengalaman makan yang istimewa.</p>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center mb-2">
                                    <span class="circle"><i class="fas fa-birthday-cake"></i></span><h5>Custom Products</h5>
                                </div>
                                <p>Nikmati kebebasan memilih ukuran, rasa dan toping yang sesuai dengan selera Anda untuk mendapatkan
                                     pengalaman yang lebih personal dalam menikmati hidangan.</p>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center mb-2">
                                    <span class="circle"><i class="fas fa-shopping-cart"></i></span><h5>Online Order</h5>
                                </div>
                                <p>Kemudahan dalam melakukan pemesanan secara online dengan berbagai metode pembayaran yang nyaman dan aman.</p>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center mb-2">
                                    <span class="circle"><i class="fa fa-truck"></i></span><h5>Home Delivery</h5>
                                </div>
                                <p>Kami mengantarkan pesanan Anda hingga ke depan pintu rumah Anda dengan sistem pembayaran pada saat pengiriman, 
